...
int main()
{
	...
	*p1 = *p2;
	...
	//Affichez p2
	//si je fais une simple copie des pointeurs, p1 et p2 vont partager les pointeurs vers les memes cases memoires,
	//il faut donc faire une deep copy dans notre constructeur de copie pour eviter qu'on accede a de la memoire desalloue lorsquon delete l'un des pointeurs
	p2->afficher();
	cout << endl;
